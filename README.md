...
- [x] App tray features custom images (different from the supplied image assets) (+1pt)
...
1. Double tap
2. Saving to camera roll

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/6h4D8fg.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
